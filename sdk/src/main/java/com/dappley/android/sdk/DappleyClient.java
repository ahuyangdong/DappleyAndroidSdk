...
public class DappleyClient {
    ...
    public static void sendTransaction(TransactionProto.Transaction.Builder transactionBuilder) throws IllegalAccessException {
        protocalProvider.sendTransaction(transactionBuilder);
    }
